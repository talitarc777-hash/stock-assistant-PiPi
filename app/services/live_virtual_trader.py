                ...
                try:
                    ledger.create_trade_event(
                        ...
                        metadata={
                            ...
                            "ticker_name_en": snapshot.get("ticker_name_en"),
                            "ticker_name_zh": snapshot.get("ticker_name_zh"),
                            "company_name": snapshot.get("company_name"),
                            "company_name_zh": snapshot.get("company_name_zh"),
                            "security_name": snapshot.get("security_name"),
                            "security_name_zh": snapshot.get("security_name_zh"),
