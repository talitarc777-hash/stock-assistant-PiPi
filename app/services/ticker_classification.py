...
TICKER_CLASSIFICATION_OVERRIDES: dict[str, dict[str, str]] = {
    ...
    "0700": {"primary_class": "stock", "stock_subclass": "communication_services"},
    "9988.HK": {"primary_class": "stock", "stock_subclass": "consumer_cyclical"},
    "9988": {"primary_class": "stock", "stock_subclass": "consumer_cyclical"},
